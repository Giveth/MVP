...
contract TokenCreator {
    ...
    CharityToken public tokenContract;  // The new token for this Campaign
    address public vaultContract;       // The address to hold the funds donated

/// @notice 'TokenCreator()' initiates the Campaign by setting its funding 
...
/// @param _vaultContract The address that will store the donated funds
    ...
    function TokenCreator(
        ...
        tokenContract = new CharityToken (); // Deploys the Token Contract
...
/// have the CharityTokens created in an address of their choosing
/// @param _owner The address that will hold the newly created CharityTokens
...
/// contract receives to the `vaultContract` and creates charityTokens in the 
...
// Creates an equal amount of CharityTokens as ether sent. The new CharityTokens
...
/// @notice `seal()` ends the Campaign by calling `seal()` in the CharityToken 
/// contract
